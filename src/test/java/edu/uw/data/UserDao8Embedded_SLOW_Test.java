...
import edu.uw.config.EmbeddedTestDataSource;
...
//@ContextConfiguration(locations = {"classpath:/userapp-spring.xml",   "classpath:/datasource-embedded-test.xml"})
